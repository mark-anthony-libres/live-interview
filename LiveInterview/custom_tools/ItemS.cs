...
namespace LiveInterview.custom_tools
{
    public class ItemS : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            main.Size = new Size(918, 98);
            main.TabIndex = 1;
            // 
            // body
            // 
            body.AutoSize = true;
            body.BackColor = SystemColors.HighlightText;
            body.Controls.Add(body_content);
            body.Dock = DockStyle.Top;
            body.Location = new Point(0, 47);
            body.Margin = new Padding(2);
            body.Name = "body";
            body.Padding = new Padding(0, 6, 0, 6);
            body.Size = new Size(918, 41);
            body.TabIndex = 5;
            // 
            // body_content
            // 
            body_content.BackColor = SystemColors.HighlightText;
            body_content.BorderStyle = BorderStyle.None;
            body_content.Font = new Font("Segoe UI", 12F);
            body_content.Location = new Point(37, 5);
            body_content.Name = "body_content";
            body_content.ScrollBars = RichTextBoxScrollBars.None;
            body_content.Size = new Size(846, 27);
            body_content.TabIndex = 0;
            ...
            header_panel.Size = new Size(918, 35);
            ...
            header_title.Size = new Size(850, 25);
            ...
            header_status.Size = new Size(32, 23);
